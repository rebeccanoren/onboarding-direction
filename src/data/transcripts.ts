...
export const transcripts: Transcript[] = [
  {
    ...
    participant: "P1",
    persona: "Developer",
    concepts: ["Onboarding app", "Sandbox 1.0"],
    date: "2026-04-24",
    sourceFile: "participant-1-dev-internal.txt",
    audience: "internal",
    summary:
      "P1 was shown the Onboarding app and Sandbox 1.0 back-to-back. Found the core testing flow intuitive — sending a message to verify functionality works quickly. Flagged friction with access key management, webhook setup, and wanted pricing information higher up. Later compared with Sandbox 1.0 and preferred its single-page layout and richer message log.",
  },
  {
    id: "t02",
    participant: "P2",
    ...
    audience: "internal",
    summary:
      "P2, familiar with the API from involvement in earlier versions, was shown Sandbox 1.0 and the Onboarding app. Strongly preferred Sandbox 1.0 for removing barriers (no sign-up required, no credit card) and for showing capability first, then exposing webhook and production complexity gradually.",
  },
  {
    id: "t03",
    participant: "P3",
    ...
    audience: "internal",
    summary:
      "P3 was shown the Onboarding app and Sandbox 1.0. Found Sandbox 1.0 more intuitive than the Onboarding app, valuing the ability to test first without sign-up friction. Appreciated interactive elements and visual feedback; noted that a 16-step onboarding felt overwhelming and preferred separating simple testing from complex agent setup.",
  },
  {
    id: "t04",
    participant: "P4",
    ...
    audience: "internal",
    summary:
      "P4 was shown the Onboarding app and Sandbox 1.0. Valued the structured Get Started approach and liked the gamification of progress indicators. Appreciated step-by-step guidance that breaks information into digestible chunks. However, found the flow unclear when transitioning from testing to production, and wanted better explanation of 'test' vs 'live'.",
  },
  {
    id: "t05",
    participant: "P5",
    ...
    audience: "internal",
    summary:
      "P5 (internal developer) was shown the Onboarding app and Sandbox 1.0. Walked through the test-first flow, verified phone number, sent a rich card, and inspected the message log to follow the message lifecycle.",
  },
  {
    id: "t06",
    participant: "P6",
    ...
    audience: "internal",
    summary:
      "P6 was shown Sandbox 1.0 and the Onboarding app. Preferred Sandbox 1.0 for its straightforward self-service style and clarity. Found the Onboarding app felt like reading 15 steps without clear action or progress. Valued doing things while learning, with interactive elements that show immediate results rather than purely informational content.",
  },
  {
    id: "t07",
    participant: "P7",
    persona: "Developer",
    concepts: ["Sandbox 2.0"],
    date: null,
    sourceFile: "Sandbox 2.0-7-dev-internal.txt",
    audience: "internal",
    summary:
      "P7 (internal) tested Sandbox 2.0 onboarding for RCS setup. Appreciated the sandbox metaphor and API playground for testing, described the flow from test messages to API integration, and suggested linking to live production setup earlier. Praised the UI design and hand-holding through regulatory steps.",
  },
  {
    id: "t08",
    participant: "P8",
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-8-dev-internal.txt",
    audience: "internal",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-9-non-dev-external.txt",
    audience: "external",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-10-dev-external.txt",
    audience: "external",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-11-dev-external.txt",
    audience: "external",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-12-dev-external.txt",
    audience: "external",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-13-dev-external.txt",
    audience: "external",
    summary:
  ...
  },
  {
    ...
    concepts: ["Sandbox 2.0"],
    date: "2026-04-23",
    sourceFile: "Sandbox 2.0-14-dev-external.txt",
    audience: "external",
    summary:
