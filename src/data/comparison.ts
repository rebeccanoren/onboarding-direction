...
export const comparisonRows: ComparisonRow[] = [
  {
    ...
    rcs2:
      "A working test message is reachable quickly. P12 called the send-test flow 'actually super easy'. P13 said 'super easy' after seeing the preview. P6 saw the purpose of RCS Getting started 1.0 as 'just try to send one test message'.",
