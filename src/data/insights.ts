...
export const insights: Insight[] = [
  {
    ...
    relatedConcepts: ["Sandbox 2.0", "Onboarding app"],
    confidence: "High",
  },
  {
    id: "i02",
    ...
    body:
      "Participants describe the 'aha' moment as seeing the message either arrive on their phone or appear in the message log. P1 said the guide should end with being able to send a message, and preferred Sandbox 2.0's message log. P7 praised the visible delivery/queue status. P11 wanted status updates so 'they'll know' what happened.",
    relatedThemes: ["Time-to-value", "Message logs"],
    relatedQuoteIds: ["q008", "q032", "q041", "q065"],
    relatedConcepts: ["Sandbox 2.0"],
    confidence: "High",
  },
  {
    id: "i03",
  ...
  {
    id: "i06",
    title: "Developers want payloads, code, and logs — and Sandbox 2.0 delivers this",
    body:
  ...
  {
    id: "i07",
    title: "Non-developers complete the Sandbox 2.0 flow but stumble on compliance",
    body:
